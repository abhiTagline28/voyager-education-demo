        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            ...
            <ScrollReveal direction="down" delay={100}>
              <div className="inline-flex items-center gap-2 rounded-full bg-white/80 backdrop-blur-sm px-4 py-2 text-xs font-semibold uppercase tracking-wider text-cyan-700 shadow-sm ring-1 ring-cyan-100 mb-4 animate-bounce-gentle">
            ...
            <ScrollReveal direction="up" delay={200} distance={30}>
              <div className="space-y-3">
                <AnimatedText variant="fade-up" delay={300}>
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-slate-900 leading-tight">
                    ...
                    <span className="relative inline-block">
                      <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 animate-gradient-shift">
                        {" "}solutions
                      </span>
                ...
                <AnimatedText variant="fade-up" delay={500}>
          ...
          {/* RIGHT IMAGE */}
          <ScrollReveal direction="left" delay={400} distance={50}>
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative group">
                {/* Glow effect */}
                <div className="absolute -inset-4 bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 rounded-3xl blur-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 animate-pulse-glow" />
                ...
                {/* Floating decoration */}
                <ScrollReveal direction="up" delay={1000} distance={30}>
                  <div className="absolute -bottom-6 -left-6 hidden lg:block animate-bounce-gentle">
